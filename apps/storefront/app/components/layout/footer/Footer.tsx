    ...
    <footer className="bg-accent-50 min-h-[140px] py-8 text-white">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr_1fr] gap-10 w-full">
          ...
          <div className="h-full flex flex-col justify-between items-center md:items-start text-center md:text-left gap-6 w-full md:pr-12">
            <LogoStoreName />
            ...
            <div className="w-full max-w-xs md:max-w-none md:w-auto mt-2 self-end md:self-start">
          ...
          {/* Right: Newsletter, Social, Notice */}
          <div className="h-full flex flex-col justify-between items-center md:items-end gap-8 w-full">
            ...
            <div className="flex flex-col gap-4 mt-4 w-full max-w-xs md:max-w-none md:w-auto self-end md:self-end">
